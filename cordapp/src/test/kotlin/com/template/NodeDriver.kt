...
fun main(args: Array<String>) {
    ...
    val user = User("user1", "test", permissions = setOf(FlowPermissions.startFlowPermission<AssetDeclare>(),
            FlowPermissions.startFlowPermission<AssetIssue>(),
            FlowPermissions.startFlowPermission<CashTransfer>()))
    driver(isDebug = true) {
